...
import { supabase, signInWithEmail, signInWithProvider, signUp, getCurrentUser } from '@/integrations/supabase/client';
...
const Auth = () => {
  ...
  const handleProviderSignIn = async (provider: 'google' | 'github' | 'facebook' | 'twitter' | 'discord') => {
    setLoading(true);
    setError(null);
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-background via-background to-secondary/30 p-4">
